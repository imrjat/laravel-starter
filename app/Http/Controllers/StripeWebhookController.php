...
class StripeWebhookController extends Controller
{
    ...
    public function handleSubscriptionUpdated(array $payload): void
    {
        ...
        $tenant->ends_at = Carbon::createFromTimestamp($payload['current_period_end'])->toDateTimeString();
        $tenant->stripe_status = $payload['status'];
        $tenant->trial_ends_at = null;
        $tenant->cancel_at_period_end = $payload['cancel_at_period_end'] ? 'Yes' : 'No';
        $tenant->canceled_at = ($payload['canceled_at'] != '') ? Carbon::createFromTimestamp($payload['canceled_at'])->toDateTimeString() : null;
        $tenant->save();
    }
    ...
    public function handleSubscriptionDeleted(array $payload): void
    {
        ...
        $tenant->trial_ends_at = null;
        $tenant->cancel_at_period_end = $payload['cancel_at_period_end'] ? 'Yes' : 'No';
        $tenant->canceled_at = Carbon::createFromTimestamp($payload['canceled_at'])->toDateTimeString();
        $tenant->save();
