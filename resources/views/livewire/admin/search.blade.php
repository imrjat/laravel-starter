        ...
        <form action="#" method="get">
            <div class="w-56 md:w-96 rounded-md">
                <div class="relative">
                    ...
                    <input wire:model.live.debounce.500ms="query" type="search" class="w-full py-2 rounded-md pl-10 bg-white dark:bg-gray-700 dark:text-gray-300 focus:outline-none" placeholder={{ __('Search') }}>
                </div>
            </div>
